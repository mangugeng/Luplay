        ...
        <main>
          <section className="block">
            <div className="relative">
              ...
              <div className={`${headlinevisible? 'opacity-0 -translate-y-[30vh] invisible' : 'opacity-100 transform-none visible ' } relative w-full container-banner-details`}>
              ...
              <div className="absolute top-0 w-full">
                <ul className="flex flex-col overflow-hidden">
                  <li>
                    <a
                      href="#"
                      className="block w-full text-white font-black border-l-4 text-lg capitalize py-2 px-5 border-l-pallete-3"
                    >
                      Episode
                    </a>
                  </li>
                  <li>
                    <a
                      href="#"
                      className="block w-full text-gray-300 font-normal border-l-4 text-lg capitalize py-2 px-5 border-l-pallete-1"
                    >
                      Trailer & Ekstra
                    </a>
                  </li>
                          ...
                          <li className="block">
                            ...
                            >
                              ...
                              <div className="inline-block ml-8 relative align-top w-[calc(100%-260px)] z-[1]">
                                <h3 className="text-gray-100 block text-base font-black mb-2 group-hover:underline">
                                ...
                                <p className="line-clamp-3 text-gray-100 block text-sm mt-3 max-h-20 overflow-hidden text-ellipsis whitespace-normal">
