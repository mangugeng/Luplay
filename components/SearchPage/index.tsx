      ...
      <div className={pageloaded ? "curtain" : "curtain h-screen"}>
        <div className="curtain__wrapper" id="curtain-wrappper">
          ...
          <div className="curtain__content" ref={curtaincontentRef}>
            {pageloaded ? (
              <main>
                {dataCollection.length == 0 && dataEpisode.length == 0 ? (
                  ...
                  <div className="mt-4">
                    ...
                    <section className="my-4 p-0 relative">
                      <div>
                        <div className="mx-4 mb-[10px]">
                          <button
                            ...
                            onClick={() =>
                              movePageFunction("/search/collection?q=" + query)
                            }
                          >
                            <h3 className="flex-[1_1] text-base font-semibold text-left text-white m-0 overflow-hidden text-ellipsis whitespace-normal line-clamp-1">
                              Koleksi
                            </h3>
                            <ChevronRightIcon className="text-white text-sm font-semibold h-4 whitespace-nowrap w-4"></ChevronRightIcon>
                          </button>
                        </div>
                      </div>
                      <div className="mx-4">
                        ...
                        >
                          {(filter === "most"
                            ...
                            .map((item: any) => (
                              <SwiperSlide
                                key={item.id_doc}
                                className="overflow-hidden h-56 cursor-pointer group rounded-md !bg-transparent"
                                onClick={() =>
                                  movePageFunction(
                                    `/${item.type}/${
                                      item.id_doc
                              ...
                              >
                                <div className="relative">
                                  <Image
                                    ...
                                    alt={item.title + "-potrait-thumbail"}
                                    width={170}
                                    height={250}
                                  />
                                </div>
                    ...
                    <section className="my-4 p-0 relative">
                      <div>
                        <div className="mx-4 mb-[10px]">
                          <button
                            ...
                            className="flex w-full justify-between items-center relative"
                            onClick={() =>
                              movePageFunction("/search/episode?q=" + query)
                            }
                          >
                            <h3 className="flex-[1_1] text-base font-semibold text-left text-white m-0 overflow-hidden text-ellipsis whitespace-normal line-clamp-1">
                              Episode
                      ...
                      <div className="mx-4">
                              ...
                              <div>
                                <div className="flex mt-4">
                                  ...
                                  <div className="flex-[1_1]">
                                    <div className="group-hover:underline text-white text-xs font-semibold leading-[1.38] mb-2 max-h-[2.76em] overflow-hidden">
                                      {item.title}
                                    </div>
                                    ...
                                    <div className="items-center text-white flex text-xs leading-[1em] mb-2 mr-[5px]">
                        ...
                        {dataEpisode.length > 20 && (
                          <button
                            onClick={() =>
                              movePageFunction("/search/episode?q=" + query)
                            }
                            className="block text-base font-semibold leading-[1.38em] m-[40px_auto_0] p-2 text-center capitalize w-[220px] bg-transparent border border-white text-white rounded hover:border-pallete-4 hover:text-pallete-4"
                          >
                            Lihat Lainnya
                          </button>
                        )}
                      ...
                      <div className="mx-auto flex justify-center max-w-[1366px] min-w-[1366px] p-[32px_0_24px] before:content-[' '] before:table after:clear-both after:content-[' '] after:table">
                        ...
                        <div className="max-w-[880px] flex-[1_1]">
                          ...
                          {dataCollection.length !== 0 ? (
                            ...
                            >
                              <div className="mb-4 mx-auto max-w-none clear-both after:clear-both after:content-[' '] after:table">
                                <div className="text-white text-2xl font-bold capitalize float-left w-4/6">
                                  Koleksi
                                </div>
                                {dataCollection.length > 8 ? (
                                  <div
                                    className="float-left pt-[6px] text-right w-1/3"
                                    onClick={() =>
                                      movePageFunction(
                                        "/search/collection?q=" + query
                                      )
                                    }
                                  >
                                    <span className="text-base font-bold capitalize transition-all duration-200 ease-linear text-blue-600 hover:text-blue-400 cursor-pointer">
                                      Lihat Semua
                                    </span>
                                  </div>
                                ) : (
                              ...
                              <div className="max-w-[880px] whitespace-nowrap">
                                <Swiper
                                  slidesPerView={5.2}
                                  spaceBetween={20}
                                  centeredSlides={false}
                          ...
                          {dataEpisode.length !== 0 ? (
                            <div
                              className={`clear-both mb-6 ${
                                stateView === "all" || stateView === "episode"
                                  ? "block"
                                  : "hidden"
                              }`}
                            >
